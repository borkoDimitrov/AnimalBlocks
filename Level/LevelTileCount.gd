...
func _ready():
	...
	$CanvasLayer/Sprite.texture = firstTile.get_node("TextureButton").texture_normal
	$CanvasLayer/Sprite.scale = Vector2(0.5, 0.5)
...
func OnMatch(tile, count):
	...
	if current_match_count % REFILMENT_MATCH_COUNT == 0:
